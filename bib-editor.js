  ...
  try {
    ...
    const response = await fetch(apiUrl, {
      headers: {
        ...
        "User-Agent": "Bib-Editor/1.14.0 (https://github.com/TeXlyre/bibtex-tidy; mailto:support@texlyre.com)"
      }
    });
    if (!response.ok) {
    ...
    if (topScore < MIN_SCORE) return void 0;
...
function addDoiToEntry(entry, doi) {
  const bracedNode = new BracedNode(null);
  ...
  bracedNode.parent = doiField.value;
